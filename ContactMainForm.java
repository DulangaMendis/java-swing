...
//--------------------LEFT SIDE---------------------------------------------------------------//
		...
		leftSide.setBackground(Color.decode("#0B5394"));
		...
		leftTitleFirstRow.setBackground(Color.decode("#0B5394"));
		...
		leftTitleSecondRow.setBackground(Color.decode("#0B5394"));
...
//----------------RIGHT SIDE-----------------------------------------------------------------//
		...
		rightSide.setBackground(Color.decode("#3D85C6"));
		...
		rightTitle.setBackground(Color.decode("#3D85C6"));
